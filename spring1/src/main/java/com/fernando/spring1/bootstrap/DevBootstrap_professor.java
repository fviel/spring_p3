...
@Component
public class DevBootstrap_professor implements ApplicationListener<ContextRefreshedEvent> {

    private AuthorRepository authorRepository;
    private BookRepository bookRepository;

    public DevBootstrap_professor(AuthorRepository authorRepository, BookRepository bookRepository) {
